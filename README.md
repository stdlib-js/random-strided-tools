...
```javascript
import ns from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-strided-tools@v0.1.1-esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { binaryFactory, ternaryFactory, unaryFactory } from 'https://cdn.jsdelivr.net/gh/stdlib-js/random-strided-tools@v0.1.1-esm/index.mjs';
```
